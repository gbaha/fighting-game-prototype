...
/*		try
	...
	public void draw(Graphics2D g, ImageObserver i, Player p1, Player p2, double w, double h)
	{
		...
		g.fillRect((int)((1245*w/1280)+0.5),(int)((650*h/720)+0.5),(int)((-500*w/1280)+0.5),(int)((35*h/720)+0.5));
		g.setColor(Color.CYAN);
		g.fillRect((int)((535*w/1280)+0.5),(int)((650*h/720)+0.5),(int)(-(500*((p1.meter-p1.meter/1000.0)/1000.0)*w/1280)+0.5),(int)((35*h/720)+0.5));
					...
					if(k < h1.buttonInputs.size())
					{
						while(!order.getFirst() && h1.buttonInputs.get(k)[1] == 0)
						{
							if(!hasButtons)
							{
								...
								g.fillOval((int)(((d)? 52:1247)*w/1280+0.5),(int)((126+i*40)*h2/720+0.5),(int)(12*w/1280+0.5),(int)(12*h2/720+0.5));
								g.fillOval((int)(((d)? 68:1247)*w/1280+0.5),(int)((126+i*40)*h2/720+0.5),(int)(12*w/1280+0.5),(int)(12*h2/720+0.5));
								g.fillOval((int)(((d)? 84:1247)*w/1280+0.5),(int)((126+i*40)*h2/720+0.5),(int)(12*w/1280+0.5),(int)(12*h2/720+0.5));
								g.fillOval((int)(((d)? 52:1247)*w/1280+0.5),(int)((142+i*40)*h2/720+0.5),(int)(12*w/1280+0.5),(int)(12*h2/720+0.5));
								g.fillOval((int)(((d)? 68:1247)*w/1280+0.5),(int)((142+i*40)*h2/720+0.5),(int)(12*w/1280+0.5),(int)(12*h2/720+0.5));
								g.fillOval((int)(((d)? 84:1247)*w/1280+0.5),(int)((142+i*40)*h2/720+0.5),(int)(12*w/1280+0.5),(int)(12*h2/720+0.5));
							}
